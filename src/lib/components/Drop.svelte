...
<div class="flex flex-col gap-3 sm:max-w-2/3">
  ...
  <button on:click={() => dispatch("collected", pendingSources)} class="w-full flex flex-row justify-center rounded-md bg-neutral-8 p-3 transition hover:(bg-neutral-3 text-neutral-8)">
